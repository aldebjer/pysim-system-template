...
cpp_ex_dir = "pysim_example_template/systems/example_cpp_systems"
...
cpp_ex_files.append("pysim_example_template/systems/example_cpp_systems.pyx")

extensions = [Extension("pysim_example_template.systems.example_cpp_systems",
                          cpp_ex_files,
                          language="c++",
              ...
              Extension("pysim_example_template.systems.example_cython_systems",
                        ['pysim_example_template/systems/example_cython_systems.pyx'],
                        language="c++",
                        extra_compile_args=extracompileargs,
                        ),
             ]
...
setup(
    ...
    packages=['pysim_example_template.systems',
              'pysim_example_template.tests',
             ],
